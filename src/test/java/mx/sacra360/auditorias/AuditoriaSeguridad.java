...
public class AuditoriaSeguridad {
    ...
    // =========================================================================
    // CASO 2: AUDITORÍA DE APLICACIÓN
    // =========================================================================
    @Test
    public void pruebaAuditoriaAplicacion() {
        ...
        System.out.println("Código obtenido de la tabla Aplicación: " + txtCodigoObtenido);
